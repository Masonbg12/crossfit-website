...
function AboutUs() {
  const coaches = [
    ...
    {
      name: "Justin Horton",
      img: "/media/coaches/justin2.webp",
    ...
    {
      name: "Hunter Myrick",
      img: "/media/coaches/hunter1.webp",
    ...
    },
    {
      ...
      img: "/media/coaches/amanda1.webp",
    ...
    {
      name: "Matt Rodriguez",
      img: "/media/coaches/shorty2.webp",
    ...
    {
      name: "Lindsay Flach",
      img: "/media/coaches/lindsay2.webp",
    ...
    },
    {
      ...
      img: "/media/coaches/anibal1.webp",
    ...
    {
      name: "Morgan Fehr",
      img: "/media/coaches/morgan1.webp",
    ...
    {
      name: "Norma Garza",
      img: "/media/coaches/norma1.webp",
      bio: "Norma joined CrossFit XLR8 in 2009 when her youngest son was 2 months old. After hearing and seeing how transformative the program had been for others, she quickly discovered for herself why CrossFit is not only effective, it’s also FUN! She convinced her husband to join shortly after, and her kiddos even participated in the CrossFit Kids program. She loves the genuine camaraderie of the CrossFit community and her XLR8 family! Norma retired from Gregory-Portland ISD in May 2025 after 28 years as a teacher and educational diagnostician, and she could not wait to spend more time at her “happy place!” She earned her CF-OL1 certification in October 2025 and hopes to encourage others in their fitness journey in the same way she has been inspired by all the amazing coaches at XLR8! And believe it or not, she actually loves burpees!"
    }
  ];
